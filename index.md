...
<p class="services-section__intro">Independent consulting across AI governance, digital transformation, infrastructure, EU research, and data — tailored for public administrations and EU institutions.</p>
...
<div class="services-grid">
  ...
  <a href="dtplead.html" class="service-card">
    <div class="service-card__icon"><i class="fa-solid fa-building-columns"></i></div>
...
<p class="services-section__intro">Consulenza indipendente su governance dell'IA, trasformazione digitale, infrastrutture, ricerca europea e gestione dei dati — per pubbliche amministrazioni e istituzioni UE.</p>
